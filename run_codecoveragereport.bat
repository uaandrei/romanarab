set dll="/testcontainer:RomanNumbersCalculator.Tests\bin\Debug\RomanNumbersCalculator.Tests.dll /noisolation"
...
set test_exe="C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\MSTest.exe"
...
%opencover_exe% -register:user -target:%test_exe% -targetargs:%dll% -filter:"+[*]* -[*Tests]*" -output:%opencoverfile%
